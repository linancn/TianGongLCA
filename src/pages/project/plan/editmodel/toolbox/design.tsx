            ...
            footer={
              <>
                ...
                <Space size={'middle'} className={styles.footer_right}>
                  ...
                  <Button onClick={onNodeOK} type="primary">
                    OK
                  </Button>
                </Space>
              </>
              ...
              <Popover
                ...
                content={
                  <SketchPicker
                    width={'230px'}
                    color={colorBGC}
                    onChange={onSketchPickerChangeBGC}
                  />
                }
                // trigger="click"
              ...
              <Popover
                ...
                content={
                  <SketchPicker
                    width={'230px'}
                    color={colorBDC}
                    onChange={onSketchPickerChangeBDC}
                  />
                }
                // trigger="click"
            ...
            elements.map((el: any) => {
              if (el.id === preid) {
                formRef.current?.setFieldsValue({
                  label: el.label,
                  type: el.type,
                  animated: el.animated.toString(),
                  arrowHeadType: el.arrowHeadType,
                  strokeWidth: el.style?.strokeWidth?.toString().replace('px', ''),
                });
              }
              return '';
            });
          ...
          <Drawer
            ...
            footer={
              <>
                ...
                <Space size={'middle'} className={styles.footer_right}>
                  <Button onClick={onDrawerCancel}>Cancel</Button>
                  <Button onClick={onEdgeOK} type="primary">
                    OK
                  </Button>
                </Space>
              </>
                  ...
                  els.map((el) => {
                    if (el.id === preid) {
                      ...
                      el = {
                        ...
                        arrowHeadType: values.arrowHeadType,
                        style: {
                          strokeWidth: `${values.strokeWidth}px`,
                        },
                      };
                    }
                    return el;
